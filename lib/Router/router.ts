...
export class Router implements IRouter {
	...
	public resolveRoute(
		...
		req.queryParams = this.requestParamsExtractor.extractQueryParamsFromURL(searchParams);
		req.pathVariables = this.requestParamsExtractor.extractPathVariablesFromURL(pathname, registeredPath);

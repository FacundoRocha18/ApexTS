...
container.register<IFastFramework>('FastFramework', FastFramework, Lifecycle.Singleton);

container.register<IMiddlewares>('Middlewares', Middlewares, Lifecycle.Singleton);
